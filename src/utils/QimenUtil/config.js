...
module.exports = class Config {
    ...
    //假如xs，ys不等，就是需要無限叠代的時候。比如xs太多的時候，ys需要跟上
                ...
                if (Object.prototype.toString.call(new_ys) == "[object Object]") {
                    if (Object.prototype.toString.call(cur) == "[object Array]") {
                        ...
                        return {
                            ...obj,
                            [cur]: {
                                [Object.keys(new_ys)[index]]: new_ys[Object.keys(new_ys)[index]],
                            },
                        };
                    }
                } else {
    ...
    static jiazi() {
        ...
        return this.range(0, 60).map(x => tiangan[this.mod(x, this.len(tiangan))] + dizhi[this.mod(x, this.len(dizhi))]);
    }
    ...
    static stc = "小寒大寒立春雨水驚蟄春分清明穀雨立夏小滿芒種夏至小暑大暑立秋處暑白露秋分寒露霜降立冬小雪大雪冬至";
    ...
    // 1901-2100年二十節氣最小公差數序列 向量壓縮法
    static encryptionVectorList = [4, 19, 3, 18, 4, 19, 4, 19, 4, 20, 4, 20, 6, 22, 6, 22, 6, 22, 7, 22, 6, 21, 6, 21];

    // 1901-2100年二十節氣數據 每個元素的存儲格式如下：
    // 1-24
    // 節氣所在天（減去節氣最小公約數）
    // 1901-2100年香港天文台公布二十四節氣按年存儲16進制，1個16進制為4個2進制
    static solarTermsData = [
        0x6aaaa6aa9a5a, 0xaaaaaabaaa6a, 0xaaabbabbafaa, 0x5aa665a65aab, 0x6aaaa6aa9a5a, 0xaaaaaaaaaa6a, 0xaaabbabbafaa, 0x5aa665a65aab, 0x6aaaa6aa9a5a, 0xaaaaaaaaaa6a, 0xaaabbabbafaa, 0x5aa665a65aab,
        0x6aaaa6aa9a56, 0xaaaaaaaa9a5a, 0xaaabaabaaeaa, 0x569665a65aaa, 0x5aa6a6a69a56, 0x6aaaaaaa9a5a, 0xaaabaabaaeaa, 0x569665a65aaa, 0x5aa6a6a65a56, 0x6aaaaaaa9a5a, 0xaaabaabaaa6a, 0x569665a65aaa,
        0x5aa6a6a65a56, 0x6aaaa6aa9a5a, 0xaaaaaabaaa6a, 0x555665665aaa, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0xaaaaaabaaa6a, 0x555665665aaa, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0xaaaaaaaaaa6a, 0x555665665aaa,
        0x5aa665a65a56, 0x6aaaa6aa9a5a, 0xaaaaaaaaaa6a, 0x555665665aaa, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0xaaaaaaaaaa6a, 0x555665655aaa, 0x569665a65a56, 0x6aa6a6aa9a56, 0xaaaaaaaa9a5a, 0x5556556559aa,
        0x569665a65a55, 0x6aa6a6a65a56, 0xaaaaaaaa9a5a, 0x5556556559aa, 0x569665a65a55, 0x5aa6a6a65a56, 0x6aaaa6aa9a5a, 0x5556556555aa, 0x569665a65a55, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0x55555565556a,
        0x555665665a55, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0x55555565556a, 0x555665665a55, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0x55555555556a, 0x555665665a55, 0x5aa665a65a56, 0x6aaaa6aa9a5a, 0x55555555556a,
        0x555665655a55, 0x5aa665a65a56, 0x6aa6a6aa9a5a, 0x55555555456a, 0x555655655a55, 0x5a9665a65a56, 0x6aa6a6a69a5a, 0x55555555456a, 0x555655655a55, 0x569665a65a56, 0x6aa6a6a65a56, 0x55555155455a,
        0x555655655955, 0x569665a65a55, 0x5aa6a5a65a56, 0x15555155455a, 0x555555655555, 0x569665665a55, 0x5aa665a65a56, 0x15555155455a, 0x555555655515, 0x555665665a55, 0x5aa665a65a56, 0x15555155455a,
        0x555555555515, 0x555665665a55, 0x5aa665a65a56, 0x15555155455a, 0x555555555515, 0x555665665a55, 0x5aa665a65a56, 0x15555155455a, 0x555555555515, 0x555655655a55, 0x5aa665a65a56, 0x15515155455a,
        0x555555554515, 0x555655655a55, 0x5a9665a65a56, 0x15515151455a, 0x555551554515, 0x555655655a55, 0x569665a65a56, 0x155151510556, 0x555551554505, 0x555655655955, 0x569665665a55, 0x155110510556,
        0x155551554505, 0x555555655555, 0x569665665a55, 0x55110510556, 0x155551554505, 0x555555555515, 0x555665665a55, 0x55110510556, 0x155551554505, 0x555555555515, 0x555665665a55, 0x55110510556,
        0x155551554505, 0x555555555515, 0x555655655a55, 0x55110510556, 0x155551554505, 0x555555555515, 0x555655655a55, 0x55110510556, 0x155151514505, 0x555555554515, 0x555655655a55, 0x54110510556,
        0x155151510505, 0x555551554515, 0x555655655a55, 0x14110110556, 0x155110510501, 0x555551554505, 0x555555655555, 0x14110110555, 0x155110510501, 0x555551554505, 0x555555555555, 0x14110110555,
        0x55110510501, 0x155551554505, 0x555555555555, 0x110110555, 0x55110510501, 0x155551554505, 0x555555555515, 0x110110555, 0x55110510501, 0x155551554505, 0x555555555515, 0x100100555,
        0x55110510501, 0x155151514505, 0x555555555515, 0x100100555, 0x54110510501, 0x155151514505, 0x555551554515, 0x100100555, 0x54110510501, 0x155150510505, 0x555551554515, 0x100100555,
        0x14110110501, 0x155110510505, 0x555551554505, 0x100055, 0x14110110500, 0x155110510501, 0x555551554505, 0x55, 0x14110110500, 0x55110510501, 0x155551554505, 0x55, 0x110110500, 0x55110510501,
        0x155551554505, 0x15, 0x100110500, 0x55110510501, 0x155551554505, 0x555555555515,
    ];
    ...
    static golen_d = ["太乙", "攝提", "軒轅", "招搖", "天符", "青龍", "鹹池", "太陰", "天乙"];

    static gtw = ["地籥", "六賊", "五符", "天曹", "地符", "風伯", "雷公", "雨師", "風雲", "唐符", "國印", "天關"];
    ...
    static twelve_luck = ["長生", "沐浴", "冠帶", "臨冠", "帝旺", "衰", "病", "死", "墓", "絕", "胎", "養"];

    static twelve_luck_i = ["死", "病", "衰", "帝旺", "臨冠", "冠帶", "沐浴", "長生", "養", "胎", "絕", "墓"];
    ...
    static getTheYearAllSolarTermsList(year) {
        return this.unZipSolarTermsList(this.solarTermsData[year - this.START_YEAR]);
    }
    ...
    static twentyfourjieqi(year) {
        ...
        for (let i in this.range(0, 23)) {
            riqi_jieqi[year.toString() + "/" + month[i].toString() + "/" + day[i].toString()] = this.solarTermsNameList[i];
        }
        return riqi_jieqi;
    }
